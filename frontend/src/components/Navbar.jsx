...
const Navbar = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 z-50 w-full transition-all duration-300 ${scrolled ? "bg-white/80 backdrop-blur-md shadow-sm" : "bg-transparent"
        }`}
    >
        ...
        <div className="hidden md:flex items-center gap-10 text-gray-700">
          {["Home", "Features", "Pricing", "Contact"].map((item) => (
            <button
              ...
              className="relative cursor-pointer transition-colors duration-300 hover:text-[#602fe2]"
            >
              {item}
          ...
          {isAuthenticated ? (
            <div className="relative" ref={menuRef}>
              <button
                ...
                className={`flex cursor-pointer items-center gap-2 rounded-full border px-1.5 py-1.5 pr-2.5 transition-all duration-200 ${menuOpen
              ...
              <div
                className={`absolute right-0 mt-2 w-44 origin-top-right rounded-xl border border-gray-100 bg-white shadow-lg transition-all duration-150 ${menuOpen
            ...
            <>
              ...
              <button
                ...
                className="cursor-pointer group rounded-full bg-[#602fe2] px-6 py-2 text-white transition-all duration-300 hover:scale-105 hover:bg-[#4f24c9] hover:shadow-lg"
              >
